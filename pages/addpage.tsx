                ...
                <form>
                    <div className="space-y-12">
                        <div className="border-b border-gray-900/10 pb-12">
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div className="sm:col-span-4">
                                    <TextEntry label="College" id="college" placeholder="CENG"/>
                                </div>
                            </div>

                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div className="sm:col-span-4">
                                    <TextEntry label="Major" id="major" placeholder="Computer Science"/>
                                </div>
                            </div>
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div className="sm:col-span-2">
                                    <TextEntry label="Facebook" id="facebook"/>
                                </div>
                                <div className="sm:col-span-2">
                                    <TextEntry label="Instagram" id="instagram"/>
                                </div>
                                <div className="sm:col-span-2">
                                    <TextEntry label="Twitter" id="twitter"/>
                                </div>
                                <div className="sm:col-span-2">
                                    <TextEntry label="LinkedIn" id="linkedin"/>
                                </div>
                                <div className="sm:col-span-2">
                                    <TextEntry label="Discord" id="discord"/>
                                </div>
                                <div className="sm:col-span-2">
                                    <TextEntry label="Github" id="github"/>
                                </div>
                            </div>
                        </div>
                    </div>
